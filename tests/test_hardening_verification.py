...
class TestHardeningVerification(unittest.TestCase):
    ...
    def test_markdown_and_docx_23_sections(self):
        ...
        self.assertIn("### 1. Sample Identification", md_content)
        self.assertIn("### 2. Reputation", md_content)
        self.assertIn("### 3. Basic Static Analysis", md_content)
        self.assertIn("### 4. Basic Behavioral Analysis", md_content)
        self.assertIn("### 5. Initial Findings", md_content)
        self.assertIn("### 6. Initial Assessment", md_content)
        self.assertIn("## PART II — ADVANCED ANALYSIS", md_content)
        self.assertIn("### 7. Advanced Static Analysis", md_content)
        self.assertIn("### 8. Assembly / Code Analysis", md_content)
        self.assertIn("### 9. API / Control Flow Analysis", md_content)
        self.assertIn("### 10. Advanced Dynamic Analysis", md_content)
        self.assertIn("### 11. Process / Thread Analysis", md_content)
        self.assertIn("### 12. Memory Analysis", md_content)
        self.assertIn("### 13. Network / C2 Analysis", md_content)
        self.assertIn("### 14. Persistence", md_content)
        self.assertIn("### 15. Anti-Analysis", md_content)
        self.assertIn("### 16. Unpacking", md_content)
        self.assertIn("### 17. Cross-Stage Correlation", md_content)
        self.assertIn("### 18. Final Assessment", md_content)
        self.assertIn("## 19. IOC (Indicators of Compromise)", md_content)
        self.assertIn("## 20. MITRE ATT&CK", md_content)
        self.assertIn("## 21. Limitations", md_content)
        self.assertIn("## 22. Evidence Appendix", md_content)
        self.assertIn("## 23. Analysis Manifest", md_content)
        ...
        self.assertTrue(any("1. Sample Identification" in h for h in headings))
        self.assertTrue(any("18. Final Assessment" in h for h in headings))
        self.assertTrue(any("23. Analysis Manifest" in h for h in headings))
